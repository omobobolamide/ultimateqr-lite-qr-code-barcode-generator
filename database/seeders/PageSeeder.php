...
class PageSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('pages')->insert([
            ...
            'meta_title' => 'Generate Custom QR Codes Online | QR Code Generator',
            'meta_description' => 'Generate custom QR codes online for free with goApps QR Code Generator. Create QR codes for URLs, text, emails, phone numbers, and more. Fast, reliable and easy to use.',
            'meta_keywords' => 'QR code generator, custom QR codes, generate QR codes online, QR code creator, free QR code generator, QR code maker, QR code scanner, goApps QR code generator.'
        ]);
