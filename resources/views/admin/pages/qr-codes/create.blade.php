                ...
                <div class="row row-deck row-cards">
                    <div class="col-sm-12 col-lg-12">
                        <div class="col">
                            ...
                            <div class="col">
                                {{-- Text --}}
                                <form action="{{ route('admin.save.qr') }}" method="post"
                                                ...
                                                <div class="sticky-top card p-3">
                                                    ...
                                                    <div class="row g-2 align-items-center mb-3 mt-3">
                                                        ...
                                                        <div class="col-6 col-sm-4 col-md-2 col-xl mb-3">
                                                            <a href="#" onclick="downloadQR('png')" class="btn btn-pink w-100">
                                                                {{ __('.PNG') }}
                                                            </a>
                                                        </div>
                                                        ...
                                                        {{-- .JPG --}}
                                                        <div class="col-6 col-sm-4 col-md-2 col-xl mb-3">
                                                            <a href="#" onclick="downloadQR('jpg')" class="btn btn-secondary w-100">
                                                                {{ __('.JPG') }}
                                                            </a>
                                                        </div>
                                                        ...
                                                        {{-- .SVG --}}
                                                        <div class="col-6 col-sm-4 col-md-2 col-xl mb-3">
                                                            <a href="#" onclick="downloadQR('svg')" class="btn btn-success w-100">
                                                                {{ __('.SVG') }}
                                                            </a>
                                                        </div>
                                                        ...
                                                        {{-- .WebP --}}
                                                        <div class="col-6 col-sm-4 col-md-2 col-xl mb-3">
                                                            <a href="#" onclick="downloadQR('webp')" class="btn btn-warning w-100">
                                                                {{ __('.WebP') }}
                                                            </a>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="col-xl-6 col-lg-6 col-md-6">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6 col-xl-6">
                                                        <div class="mb-3">
                                                            <label class="form-label required">{{ __('QR Code Type') }}</label>
                                                            <select name="qrcode_type"
                                                                onchange="redirectQrType(this.value)"
                                                                class="form-select" required>
                                                                <option value="text">{{ __('Plain Text') }}</option>
                                                                <option value="email">{{ __('Email') }}</option>
                                                                <option value="sms">{{ __('Text Message') }}</option>
                                                                <option value="whatsapp">{{ __('WhatsApp Message') }}</option>
                                                                <option value="url">{{ __('URL') }}</option>
                                                                <option value="location">{{ __('Map Location') }}</option>
                                                                <option value="phone">{{ __('Phone Number') }}</option>
                                                                <option value="facetime">{{ __('Facetime') }}</option>
                                                                <option value="event">{{ __('Event') }}</option>
                                                                <option value="wifi">{{ __('WiFi') }}</option>
                                                                <option value="crypto">{{ __('Crypto Payment') }}</option>
                                                                <option value="paypal">{{ __('Paypal Payment') }}</option>
                                                                <option value="vcard">{{ __('Save Contact') }}</option>
                                                                <option value="upi">{{ __('UPI Payment') }}</option>
                                                            </select>
                                                    ...
                                                    {{-- Selected Type --}}
                                                    <input type="hidden" class="form-control" id="selectedQrCodeType">
                                                    ...
                                                    <div class="col-md-6 col-xl-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control" name="name" value="{{ uniqid() }}"
                                                                id="name" maxlength="100" placeholder="{{ __('Name') }}" required>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col">
                                                        <div class="card">
                                                            <div class="card-body">
                                                                <div class="card-title">{{ __('Advanced Settings') }}</div>
                                                                ...
                                                                <div class="pt-1">
                                                                    ...
                                                                    <div class="col-md-12 col-xl-12">
                                                                        <div class="mb-3">
                                                                            <label class="form-label">{{ __('QR Code Style') }}</label>
                                                                            <div class="form-selectgroup">
                                                                                <label class="form-selectgroup-item">
                                                                                    <input type="radio" name="qrcode_style" id="qrcode_style" value="square" onclick="regenerateQrCode()" class="form-selectgroup-input" checked>
                                                                                    <span class="form-selectgroup-label"><!-- Download SVG icon from http://tabler-icons.io/i/home -->
                                                                                
                                                                                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler me-1 icon-tabler-square" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                                                                ...
                                                                                <label class="form-selectgroup-item">
                                                                                    <input type="radio" name="qrcode_style" id="qrcode_style" value="dot" onclick="regenerateQrCode()" class="form-selectgroup-input">
                                                                                    <span class="form-selectgroup-label"><!-- Download SVG icon from http://tabler-icons.io/i/home -->
                                                                                        <svg xmlns="http://www.w3.org/2000/svg" class="icon me-1 icon-tabler icon-tabler-grain" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                                                                ...
                                                                                <label class="form-selectgroup-item">
                                                                                    <input type="radio" name="qrcode_style" id="qrcode_style" value="round" onclick="regenerateQrCode()" class="form-selectgroup-input">
                                                                                    <span class="form-selectgroup-label"><!-- Download SVG icon from http://tabler-icons.io/i/home -->
                                                                                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler me-1 icon-tabler-border-radius" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                                                    ...
                                                                    <div class="col-md-12 col-xl-12">
                                                                        <div class="mb-3">
                                                                            <label
                                                                                ...
                                                                                <div class="form-selectgroup">
                                                                                    <label class="form-selectgroup-item">
                                                                                        <input type="radio" name="color_style" value="color" onclick="checkColor(this); regenerateQrCode();" class="form-selectgroup-input" checked>
                                                                                        <span class="form-selectgroup-label"><!-- Download SVG icon from http://tabler-icons.io/i/home -->
                                                                                        
                                                                                            <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler me-1 icon-tabler-brush" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                                                                        ...
                                                                                        <label class="form-selectgroup-item">
                                                                                        <input type="radio" name="color_style" value="gradient" onclick="checkColor(this); regenerateQrCode();" class="form-selectgroup-input">
                                                                                        <span class="form-selectgroup-label"><!-- Download SVG icon from http://tabler-icons.io/i/home -->
                                                                                        
                                                                                            <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler me-1 icon-tabler-palette" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                                                    ...
                                                                    {{-- Color --}}
                                                                    <div
                                                                        class="col-md-12 col-xl-12 color-form-group">
                                                                        <div class="mb-3">
                                                                            <label
                                                                    ...
                                                                    {{-- Gradient type --}}
                                                                    <div
                                                                        class="col-md-12 col-xl-12 gradient-form-group">
                                                                        <div class="mb-3">
                                                                            <label class="form-label">{{ __('Gradient type') }}</label>
                                                                            {{-- Vertical --}}
                                                                            <div class="form-selectgroup">
                                                                                <label class="form-selectgroup-item">
                                                                                    <input type="radio" name="foreground_gradient_type" id="foreground_gradient_type" value="vertical" onclick="regenerateQrCode()" class="form-selectgroup-input" checked>
                                                                            ...
                                                                            <div class="form-selectgroup">
                                                                                <label class="form-selectgroup-item">
                                                                                    <input type="radio" name="foreground_gradient_type" id="foreground_gradient_type" value="horizontal" onclick="regenerateQrCode()" class="form-selectgroup-input">
                                                                                    <span class="form-selectgroup-label">
                                                                                        {{ __("Horizontal") }}
                                                                                    </span>
                                                                                </label>
                                                                            ...
                                                                            <div class="form-selectgroup">
                                                                                <label class="form-selectgroup-item">
                                                                                    <input type="radio" name="foreground_gradient_type" id="foreground_gradient_type" value="diagonal" onclick="regenerateQrCode()" class="form-selectgroup-input">
                                                                                    <span class="form-selectgroup-label">
                                                                                        {{ __("Diagonal") }}
                                                                                    </span>
                                                                                </label>
                                                                            ...
                                                                            <div class="form-selectgroup">
                                                                                <label class="form-selectgroup-item">
                                                                                    <input type="radio" name="foreground_gradient_type" id="foreground_gradient_type" value="inverse_diagonal" onclick="regenerateQrCode()" class="form-selectgroup-input">
                                                                                    <span class="form-selectgroup-label">
                                                                                        {{ __("Inverse diagonal") }}
                                                                                    </span>
                                                                                </label>
                                                                            ...
                                                                            <div class="form-selectgroup">
                                                                                <label class="form-selectgroup-item">
                                                                                    <input type="radio" name="foreground_gradient_type" id="foreground_gradient_type" value="radial" onclick="regenerateQrCode()" class="form-selectgroup-input">
                                                                                    <span class="form-selectgroup-label">
                                                                                        {{ __("Radial") }}
                                                                                    </span>
                                                                                </label>
                                                                    ...
                                                                    <div class="col-md-12 col-xl-12">
                                                                        <div class="mb-3">
                                                                            <label class="form-label">{{ __('Need eye color?') }}</label>
                                                                            {{-- Yes --}}
                                                                            <div class="form-selectgroup">
                                                                                <label class="form-selectgroup-item">
                                                                                    <input type="radio" name="need_eye_color" id="need_eye_color" value="1" onchange="checkEyeColor(this.value); regenerateQrCode();" class="form-selectgroup-input">
                                                                                    <span class="form-selectgroup-label">
                                                                                        {{ __("Yes") }}
                                                                                    </span>
                                                                                </label>
                                                                            ...
                                                                            <div class="form-selectgroup">
                                                                                <label class="form-selectgroup-item">
                                                                                    <input type="radio" name="need_eye_color" id="need_eye_color" value="0" onchange="checkEyeColor(this.value); regenerateQrCode();" class="form-selectgroup-input" checked>
                                                                                    <span class="form-selectgroup-label">
                                                                                        {{ __("No") }}
                                                                                    </span>
                                                                                </label>
                                                                    ...
                                                                    <div
                                                                        class="col-md-12 col-xl-12 eyes_control">
                                                                        <div class="mb-3">
                                                                            <label
                                                                    ...
                                                                    <div
                                                                        class="col-md-12 col-xl-12 eyes_control">
                                                                        <div class="mb-3">
                                                                            <label class="form-label">{{ __('Eye Color Position') }}</label>
                                                                            {{-- Left --}}
                                                                            <div class="form-selectgroup">
                                                                                <label class="form-selectgroup-item">
                                                                                    <input type="radio" name="eyeColor_position" id="eyeColor_position" value="0" onchange="regenerateQrCode()" class="form-selectgroup-input" checked>
                                                                                    <span class="form-selectgroup-label">
                                                                                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler me-1 icon-tabler-float-left" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                                                            ...
                                                                            <div class="form-selectgroup">
                                                                                <label class="form-selectgroup-item">
                                                                                    <input type="radio" name="eyeColor_position" id="eyeColor_position" value="1" onchange="regenerateQrCode()" class="form-selectgroup-input">
                                                                                    <span class="form-selectgroup-label">
                                                                                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler me-1 icon-tabler-float-right" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                                                            ...
                                                                            <div class="form-selectgroup">
                                                                                <label class="form-selectgroup-item">
                                                                                    <input type="radio" name="eyeColor_position" id="eyeColor_position" value="2" onchange="regenerateQrCode()" class="form-selectgroup-input">
                                                                                    <span class="form-selectgroup-label">
                                                                                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler me-1 icon-tabler-float-center" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                                                    ...
                                                                    <div
                                                                        class="col-md-12 col-xl-12 eyes_control">
                                                                        <div class="mb-3">
                                                                            <label class="form-label">{{ __('Eye Color Style') }}</label>
                                                                            {{-- Square --}}
                                                                            <div class="form-selectgroup">
                                                                                <label class="form-selectgroup-item">
                                                                                    <input type="radio" name="eye_color_style" id="eye_color_style" value="square" onchange="regenerateQrCode()" class="form-selectgroup-input" checked>
                                                                                    <span class="form-selectgroup-label">
                                                                                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler me-1 icon-tabler-square" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                                                                            <desc>Download more icon variants from https://tabler-icons.io/i/square</desc>
                                                                                            <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                                                                            ...
                                                                            <div class="form-selectgroup">
                                                                                <label class="form-selectgroup-item">
                                                                                    <input type="radio" name="eye_color_style" id="eye_color_style" value="circle" onchange="regenerateQrCode()" class="form-selectgroup-input">
                                                                                    <span class="form-selectgroup-label">
                                                                                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler me-1 icon-tabler-circle" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                                                ...
                                                                <div class="pt-1">
                                                                    ...
                                                                    <div class="col-md-12 col-xl-12">
                                                                        <div class="mb-3">
                                                                            <label class="form-label">{{ __('Upload Logo Size') }}</label>
                                                                            {{-- Small --}}
                                                                            <div class="form-selectgroup">
                                                                                <label class="form-selectgroup-item">
                                                                                    <input type="radio" name="upload_logo_size" id="upload_logo_size" value="0.1" onclick="regenerateQrCode()" class="form-selectgroup-input">
                                                                                    <span class="form-selectgroup-label">
                                                                                        {{ __("Small") }}
                                                                                    </span>
                                                                                </label>
                                                                            ...
                                                                            <div class="form-selectgroup">
                                                                                <label class="form-selectgroup-item">
                                                                                    <input type="radio" name="upload_logo_size" id="upload_logo_size" value="0.2" onclick="regenerateQrCode()" class="form-selectgroup-input" checked>
                                                                                    <span class="form-selectgroup-label">
                                                                                        {{ __("Medium") }}
                                                                                    </span>
                                                                                </label>
                                                                            ...
                                                                            <div class="form-selectgroup">
                                                                                <label class="form-selectgroup-item">
                                                                                    <input type="radio" name="upload_logo_size" id="upload_logo_size" value="0.5" onclick="regenerateQrCode()" class="form-selectgroup-input">
                                                                                    <span class="form-selectgroup-label">
                                                                                        {{ __("Large") }}
                                                                                    </span>
                                                                                </label>
                                                                ...
                                                                <div class="pt-1">
                                                                    ...
                                                                    <div class="col-md-12 col-xl-12">
                                                                        <div class="mb-3">
                                                                            <label class="form-label">{{ __('Download Quality') }}</label>
                                                                            {{-- Basic --}}
                                                                            <div class="form-selectgroup">
                                                                                <label class="form-selectgroup-item">
                                                                                    <input type="radio" name="size" id="size" value="200" onchange="regenerateQrCode()" class="form-selectgroup-input">
                                                                                    <span class="form-selectgroup-label">
                                                                                        {{ __("Basic") }}
                                                                                    </span>
                                                                                </label>
                                                                            ...
                                                                            <div class="form-selectgroup">
                                                                                <label class="form-selectgroup-item">
                                                                                    <input type="radio" name="size" id="size" value="500" onchange="regenerateQrCode()" class="form-selectgroup-input" checked>
                                                                                    <span class="form-selectgroup-label">
                                                                                        {{ __("Normal") }}
                                                                                    </span>
                                                                                </label>
                                                                            ...
                                                                            <div class="form-selectgroup">
                                                                                <label class="form-selectgroup-item">
                                                                                    <input type="radio" name="size" id="size" value="1000" onchange="regenerateQrCode()" class="form-selectgroup-input">
                                                                                    <span class="form-selectgroup-label">
                                                                                        {{ __("Fine") }}
                                                                                    </span>
                                                                                </label>
                                                                            ...
                                                                            <div class="form-selectgroup">
                                                                                <label class="form-selectgroup-item">
                                                                                    <input type="radio" name="size" id="size" value="1500" onchange="regenerateQrCode()" class="form-selectgroup-input">
                                                                                    <span class="form-selectgroup-label">
                                                                                        {{ __("High") }}
                                                                                    </span>
                                                                                </label>
                                                                            ...
                                                                            <div class="form-selectgroup">
                                                                                <label class="form-selectgroup-item">
                                                                                    <input type="radio" name="size" id="size" value="2000" onchange="regenerateQrCode()" class="form-selectgroup-input">
                                                                                    <span class="form-selectgroup-label">
                                                                                        {{ __("Very High") }}
                                                                                    </span>
                                                                                </label>
                                                                    ...
                                                                    <div class="col-md-12 col-xl-12">
                                                                        <div class="mb-3">
                                                                            <label class="form-label">{{ __('Level of error correction') }}</label>
                                                                            {{-- Low --}}
                                                                            <div class="form-selectgroup">
                                                                                <label class="form-selectgroup-item">
                                                                                    <input type="radio" name="qrcode_ecc" id="qrcode_ecc" value="L" onchange="regenerateQrCode()" class="form-selectgroup-input" checked>
                                                                                    <span class="form-selectgroup-label">
                                                                                        {{ __("Low") }}
                                                                                    </span>
                                                                                </label>
                                                                            ...
                                                                            <div class="form-selectgroup">
                                                                                <label class="form-selectgroup-item">
                                                                                    <input type="radio" name="qrcode_ecc" id="qrcode_ecc" value="M" onchange="regenerateQrCode()" class="form-selectgroup-input">
                                                                                    <span class="form-selectgroup-label">
                                                                                        {{ __("Medium") }}
                                                                                    </span>
                                                                                </label>
                                                                            ...
                                                                            <div class="form-selectgroup">
                                                                                <label class="form-selectgroup-item">
                                                                                    <input type="radio" name="qrcode_ecc" id="qrcode_ecc" value="Q" onchange="regenerateQrCode()" class="form-selectgroup-input">
                                                                                    <span class="form-selectgroup-label">
                                                                                        {{ __("Quartile") }}
                                                                                    </span>
                                                                                </label>
                                                                            ...
                                                                            <div class="form-selectgroup">
                                                                                <label class="form-selectgroup-item">
                                                                                    <input type="radio" name="qrcode_ecc" id="qrcode_ecc" value="H" onchange="regenerateQrCode()" class="form-selectgroup-input">
                                                                                    <span class="form-selectgroup-label">
                                                                                        {{ __("High") }}
                                                                                    </span>
                                                                                </label>
                                                    ...
                                                    {{-- Generate QR Code --}}
                                                    <span class="text-muted mt-3">{{ __('Note: Double-check your QR Code once before using it.')}}</span>
...
@section('custom-js')
    <script>
        ...
        // Text
        var generateCode = '<div class="col-md-12 col-xl-12">\
                            <div class="mb-3">\
                                <label class="form-label required">{{ __("Content") }}</label>\
                                <textarea name="content" id="content" minlength="1" maxlength="350" placeholder="Lorem ipsum..." class="form-control" cols="30" rows="5" onchange="regenerateQrCode()" required></textarea>\
                            </div>\
                        </div>';
        $('#generate').html(generateCode);
        $('#selectedQrCodeType').val('text');

        // Check QR Code type
        function redirectQrType(type) {
            "use strict";
            ...
            if(type == "text") {
                // Text
                $('#selectedQrCodeType').val('text');
                generateCode = '<div class="col-md-12 col-xl-12">\
                                    <div class="mb-3">\
                                        <label class="form-label required">{{ __("Content") }}</label>\
                                        <textarea name="content" id="content" minlength="1" maxlength="350" placeholder="Lorem ipsum..." class="form-control" cols="30" rows="5" onchange="regenerateQrCode()" required></textarea>\
                                    </div>\
            ...
            if(type == "url") {
                // URL
                $('#selectedQrCodeType').val('url');
                generateCode = '<div class="col-md-12 col-xl-12">\
                                    <div class="mb-3">\
                                        <label class="form-label required">{{ __("Link Url") }}</label>\
                                        <input type="url" class="form-control" name="url" onchange="regenerateQrCode()" id="content" placeholder="{{ __("Ex: http://domain.com") }}" required>\
                                    </div>\
                                </div>\
                                    ...
                                    <div class="col-md-12 col-xl-12">\
                                        <div class="mb-3">\
                                            <label class="form-check">\
                                                <input class="form-check-input" type="checkbox" name="enable_analytics" id="enable_analytics" onclick="regenerateQrCode()">\
                                                <span class="form-check-label">{{ __("Enable Analytics") }}</span>\
                                            </label>\
                                        </div>\
                                    </div>\
                                </div>';
            ...
            if(type == "phone") {
                // Phone
                $('#selectedQrCodeType').val('phone');
                generateCode = '<div class="col-md-12 col-xl-12">\
                                    <div class="mb-3">\
                                        <label class="form-label required">{{ __("Mobile Number") }}</label>\
                                        <input type="text" class="form-control" maxlength="25" name="content" onchange="regenerateQrCode()" id="content" placeholder="{{ __("Mobile Number") }}" required>\
                                    </div>\
                                </div>';
                $('#generate').html(generateCode);
            }
            ...
            if(type == "sms") {
                // SMS
                $('#selectedQrCodeType').val('sms');
                generateCode = '<div class="col-md-12 col-xl-12">\
                                    <div class="mb-3">\
                                        <label class="form-label required">{{ __("Mobile Number") }}</label>\
                                        <input type="text" class="form-control" name="phone" maxlength="25" onchange="regenerateQrCode()" id="phone" placeholder="{{ __("Mobile Number") }}" required>\
                                    </div>\
                                </div>\
                                <div class="col-md-12 col-xl-12">\
                                    <div class="mb-3">\
                                        <label class="form-label required">{{ __("Message") }}</label>\
                                        <textarea name="content" id="content" maxlength="256" class="form-control" cols="30" rows="5" onchange="regenerateQrCode()" required></textarea>\
                                    </div>\
                                </div>';
                $('#generate').html(generateCode);
            }
            ...
            if(type == "email") {
                // Email
                $('#selectedQrCodeType').val('email');
                generateCode = '<div class="col-md-12 col-xl-12">\
                                    <div class="mb-3">\
                                        <label class="form-label required">{{ __("Email ID") }}</label>\
                                        <input type="text" class="form-control" name="email" onchange="regenerateQrCode()" maxlength="50" id="email" placeholder="{{ __("Email ID") }}" required>\
                                    </div>\
                                </div>\
                                <div class="col-md-12 col-xl-12">\
                                    <div class="mb-3">\
                                        <label class="form-label required">{{ __("Subject") }}</label>\
                                        <input type="text" class="form-control" name="subject" onchange="regenerateQrCode()" maxlength="50" id="subject" placeholder="{{ __("Subject") }}" required>\
                                    </div>\
                                </div>\
                                <div class="col-md-12 col-xl-12">\
                                    <div class="mb-3">\
                                        <label class="form-label required">{{ __("Body") }}</label>\
                                        <textarea name="content" id="content" class="form-control" cols="30" maxlength="300" rows="5" onchange="regenerateQrCode()" required></textarea>\
                                    </div>\
                                </div>';
                $('#generate').html(generateCode);
            }
            ...
            if(type == "whatsapp") {
                // WhatsApp
                $('#selectedQrCodeType').val('whatsapp');
                generateCode = '<div class="col-md-12 col-xl-12">\
                                    <div class="mb-3">\
                                        <label class="form-label required">{{ __("WhatsApp Number") }}</label>\
                                        <input type="text" class="form-control" name="phone" onchange="regenerateQrCode()" id="phone" maxlength="25" placeholder="{{ __("WhatsApp Number") }}" required>\
                                        <small class="mt-2">{{ __("Include country code (For ex: 919876543210)") }}</small>\
                                    </div>\
                                </div>\
                                <div class="col-md-12 col-xl-12">\
                                    <div class="mb-3">\
                                        <label class="form-label required">{{ __("Message") }}</label>\
                                        <textarea name="content" id="content" class="form-control" cols="30" maxlength="350" rows="5" onchange="regenerateQrCode()" required></textarea>\
                                    </div>\
                                </div>';
                $('#generate').html(generateCode);
            }
            ...
            if(type == "facetime") {
                // Facetime
                $('#selectedQrCodeType').val('facetime');
                generateCode = '<div class="col-md-12 col-xl-12">\
                                    <div class="mb-3">\
                                        <label class="form-label required">{{ __("Mobile number/email ID") }}</label>\
                                        <input type="text" class="form-control" name="content" onchange="regenerateQrCode()" id="content" placeholder="{{ __("Mobile number/email ID") }}" required>\
                                        <small class="mt-3">{{ __("Only support on iOS & MacOS Devices") }}</small>\
                                    </div>\
                                </div>';
                $('#generate').html(generateCode);
            }
            ...
            if(type == "location") {
                // Location
                $('#selectedQrCodeType').val('location');
                generateCode = '<div class="col-md-12 col-xl-12">\
                                    <div class="mb-3">\
                                        <label class="form-label required">{{ __("Latitude") }}</label>\
                                        <input type="text" class="form-control" maxlength="50" name="latitude" onchange="regenerateQrCode()" id="latitude" placeholder="{{ __("Latitude") }}" required>\
                                    </div>\
                                </div>\
                                <div class="col-md-12 col-xl-12">\
                                    <div class="mb-3">\
                                        <label class="form-label required">{{ __("Longitude") }}</label>\
                                        <input type="text" class="form-control" maxlength="50" name="longitude" onchange="regenerateQrCode()" id="longitude" placeholder="{{ __("Longitude") }}" required>\
                                    </div>\
                                </div>';
                $('#generate').html(generateCode);
            }
            ...
            if(type == "wifi") {
                // WiFi
                $('#selectedQrCodeType').val('wifi');
                generateCode = '<div class="col-md-12 col-xl-12">\
                                    <div class="mb-3">\
                                        <label class="form-label required">{{ __("Network Name (SSID)") }}</label>\
                                        <input type="text" class="form-control" name="wifi_ssid" maxlength="100" onchange="regenerateQrCode()" id="wifi_ssid" placeholder="{{ __("Network Name (SSID)") }}" required>\
                                    </div>\
                                </div>\
                                <div class="col-md-12 col-xl-12">\
                                    <div class="mb-3">\
                                        <label class="form-label">{{ __("Security") }}</label>\
                                        <select class="form-select" name="wifi_encryption" id="wifi_encryption" onchange="regenerateQrCode()">\
                                            <option value="nopass">{{ __("None") }}</option>\
                                            <option value="WEP">{{ __("WEP") }}</option>\
                                            <option value="WPA">{{ __("WPA/WPA2-Personal") }}</option>\
                                        </select>\
                                    </div>\
                                </div>\
                                <div class="col-md-12 col-xl-12">\
                                    <div class="mb-3">\
                                        ...
                                        <input type="text" class="form-control" name="wifi_password" maxlength="25" onchange="regenerateQrCode()" id="wifi_password" placeholder="{{ __("Password") }}" required>\
                                    </div>\
                                </div>\
                                <div class="col-md-12 col-xl-12">\
                                    <div class="mb-3">\
                                        <label class="form-label">{{ __("Hidden?") }}</label>\
                                        <select class="form-select" name="wifi_is_hidden" id="wifi_is_hidden" onchange="regenerateQrCode()">\
            ...
            if(type == "event") {
                // Event
                $('#selectedQrCodeType').val('event');
                generateCode = '<div class="col-md-12 col-xl-12">\
                                    <div class="mb-3">\
                                        <label class="form-label required">{{ __("Title") }}</label>\
                                        <input type="text" class="form-control" name="event" onchange="regenerateQrCode()" id="event" placeholder="{{ __("Title") }}" required>\
                                    </div>\
                                </div>\
                                <div class="col-md-12 col-xl-12">\
                                    <div class="mb-3">\
                                        <label class="form-label required">{{ __("Message") }}</label>\
                                        <textarea name="event_note" id="event_note" class="form-control" maxlength="220" cols="30" rows="2" onchange="regenerateQrCode()" required></textarea>\
                                    </div>\
                                </div>\
                                <div class="col-md-12 col-xl-12">\
                                    <div class="mb-3">\
                                        <label class="form-label required">{{ __("Location") }}</label>\
                                        <input type="text" class="form-control" name="event_location" onchange="regenerateQrCode()" id="event_location" placeholder="{{ __("Location") }}" required>\
                                    </div>\
                                </div>\
                                <div class="col-md-12 col-xl-12">\
                                    <div class="mb-3">\
                                        <label class="form-label required">{{ __("From") }}</label>\
                                        <input type="datetime-local" class="form-control" name="event_start_datetime" onchange="regenerateQrCode()" id="event_start_datetime" placeholder="{{ __("From") }}" required>\
                                    </div>\
                                </div>\
                                <div class="col-md-12 col-xl-12">\
                                    <div class="mb-3">\
                                        <label class="form-label required">{{ __("To") }}</label>\
                                        <input type="datetime-local" class="form-control" name="event_end_datetime" onchange="regenerateQrCode()" id="event_end_datetime" placeholder="{{ __("To") }}" required>\
                                    </div>\
                                </div>';
                $('#generate').html(generateCode);
            }
            ...
            if(type == "crypto") {
                // Crypto
                $('#selectedQrCodeType').val('crypto');
                generateCode = '<div class="col-md-12 col-xl-12">\
                                    <div class="mb-3">\
                                        <label class="form-label required">{{ __("Cryptocurrency") }}</label>\
                                        <select class="form-select" name="crypto_coin" id="crypto_coin" onchange="regenerateQrCode()" required>\
                                            <option value="bitcoin">{{ __("Bitcoin") }}</option>\
                                            <option value="bitcoincash">{{ __("Bitcoin cash address") }} </option>\
                                            <option value="ethereum">{{ __("Ether") }}</option>\
                                            <option value="litecoin">{{ __("Litecoin") }}</option>\
                                ...
                                <div class="col-md-12 col-xl-12">\
                                    <div class="mb-3">\
                                        <label class="form-label required">{{ __("Receiver") }}</label>\
                                        <input type="text" class="form-control" name="crypto_address" maxlength="250" onchange="regenerateQrCode()" id="crypto_address" placeholder="{{ __("Receiver") }}" required>\
                                    </div>\
                                </div>\
                                <div class="col-md-12 col-xl-12">\
                                    <div class="mb-3">\
                                        <label class="form-label required">{{ __("Amount") }}</label>\
                                        <input type="text" class="form-control" name="crypto_amount" maxlength="15" onchange="regenerateQrCode()" id="crypto_amount" placeholder="{{ __("Amount") }}" required>\
                                    </div>\
                                </div>\
                                <div class="col-md-12 col-xl-12">\
                                    <div class="mb-3">\
                                        <label class="form-label required">{{ __("Message") }}</label>\
                                        <textarea name="crypto_msg" id="crypto_msg" class="form-control" cols="30" rows="2" maxlength="150" onchange="regenerateQrCode()" required></textarea>\
                                    </div>\
                                </div>';
                $('#generate').html(generateCode);
            }
            ...
            if(type == "vcard") {
                // Vcard
                $('#selectedQrCodeType').val('vcard');
                generateCode = '<div class="col-md-12 col-xl-12">\
                                    <div class="mb-3">\
                                        <label class="form-label required">{{ __("First name") }}</label>\
                                        <input type="text" class="form-control" name="vcard_first_name" onchange="regenerateQrCode()" maxlength="40" id="vcard_first_name" placeholder="{{ __("First name") }}" required>\
                                    </div>\
                                </div>\
                                <div class="col-md-12 col-xl-12">\
                                    <div class="mb-3">\
                                        <label class="form-label required">{{ __("Last name") }}</label>\
                                        <input type="text" class="form-control" name="vcard_last_name" onchange="regenerateQrCode()" maxlength="40" id="vcard_last_name" placeholder="{{ __("Last name") }}" required>\
                                    </div>\
                                </div>\
                                <div class="col-md-12 col-xl-12">\
                                    <div class="mb-3">\
                                        <label class="form-label required">{{ __("Mobile number") }}</label>\
                                        <input type="text" class="form-control" name="vcard_phone" onchange="regenerateQrCode()" id="vcard_phone" maxlength="20" placeholder="{{ __("Mobile number") }}" required>\
                                    </div>\
                                </div>\
                                <div class="col-md-12 col-xl-12">\
                                    <div class="mb-3">\
                                        <label class="form-label required">{{ __("Email Address") }}</label>\
                                        <input type="email" class="form-control" name="vcard_email" onchange="regenerateQrCode()" maxlength="50" id="vcard_email" placeholder="{{ __("Email Address") }}" required>\
                                    </div>\
                                </div>\
                                <div class="col-md-12 col-xl-12">\
                                    <div class="mb-3">\
                                        <label class="form-label required">{{ __("Website Link") }}</label>\
                                        <input type="url" class="form-control" name="vcard_url" onchange="regenerateQrCode()" id="vcard_url" maxlength="50" placeholder="{{ __("Website Link") }}" required>\
                                    </div>\
                                </div>\
                                <div class="col-md-12 col-xl-12">\
                                    <div class="mb-3">\
                                        <label class="form-label required">{{ __("Company Name") }}</label>\
                                        <input type="text" class="form-control" name="vcard_company" onchange="regenerateQrCode()" maxlength="50" id="vcard_company" placeholder="{{ __("Company Name") }}" required>\
                                    </div>\
                                </div>\
                                <div class="col-md-12 col-xl-12">\
                                    <div class="mb-3">\
                                        <label class="form-label required">{{ __("Job Position") }}</label>\
                                        <input type="text" class="form-control" name="vcard_job_title" onchange="regenerateQrCode()" maxlength="50" id="vcard_job_title" placeholder="{{ __("Job Position") }}" required>\
                                    </div>\
                                </div>\
                                <div class="col-md-12 col-xl-12">\
                                    <div class="mb-3">\
                                        <label class="form-label required">{{ __("DOB") }}</label>\
                                        <input type="date" class="form-control" name="vcard_birthday" onchange="regenerateQrCode()" id="vcard_birthday" placeholder="{{ __("DOB") }}" required>\
                                    </div>\
                                </div>\
                                <div class="col-md-12 col-xl-12">\
                                    <div class="mb-3">\
                                        <label class="form-label required">{{ __("Street") }}</label>\
                                        <input type="text" class="form-control" name="vcard_street" onchange="regenerateQrCode()" maxlength="100" id="vcard_street" placeholder="{{ __("Street") }}" required>\
                                    </div>\
                                </div>\
                                <div class="col-md-12 col-xl-12">\
                                    <div class="mb-3">\
                                        <label class="form-label required">{{ __("City") }}</label>\
                                        <input type="text" class="form-control" name="vcard_city" onchange="regenerateQrCode()" maxlength="50" id="vcard_city" placeholder="{{ __("City") }}" required>\
                                    </div>\
                                </div>\
                                <div class="col-md-12 col-xl-12">\
                                    <div class="mb-3">\
                                        <label class="form-label required">{{ __("Postal Code") }}</label>\
                                        <input type="text" class="form-control" name="vcard_postal" onchange="regenerateQrCode()" maxlength="25" id="vcard_postal" placeholder="{{ __("Postal Code") }}" required>\
                                    </div>\
                                </div>\
                                <div class="col-md-12 col-xl-12">\
                                    <div class="mb-3">\
                                        <label class="form-label required">{{ __("Region") }}</label>\
                                        <input type="text" class="form-control" name="vcard_region" onchange="regenerateQrCode()" maxlength="50" id="vcard_region" placeholder="{{ __("Region") }}" required>\
                                    </div>\
                                </div>\
                                <div class="col-md-12 col-xl-12">\
                                    <div class="mb-3">\
                                        <label class="form-label required">{{ __("Country") }}</label>\
                                        <input type="text" class="form-control" name="vcard_country" onchange="regenerateQrCode()" maxlength="50" id="vcard_country" placeholder="{{ __("Country") }}" required>\
                                    </div>\
                                </div>\
                                <div class="col-md-12 col-xl-12">\
                                    <div class="mb-3">\
                                        <label class="form-label required">{{ __("More Info") }}</label>\
                                        <textarea name="vcard_note" id="vcard_note" class="form-control" cols="30" rows="2" maxlength="100" onchange="regenerateQrCode()" required></textarea>\
                                    </div>\
                                </div>';
                $('#generate').html(generateCode);
            }
            ...
            if(type == "paypal") {
                // Paypal
                $('#selectedQrCodeType').val('paypal');
                generateCode = '<div class="col-md-12 col-xl-12">\
                                    <div class="mb-3">\
                                        <label class="form-label required">{{ __("Paypal.Me Link") }}</label>\
                                        <div class="input-group input-group-flat">\
                                            <span class="input-group-text">{{ __("https://paypal.me/") }}</span>\
                                            <input type="text" class="form-control ps-0" name="paypal_link" id="paypal_link" onchange="regenerateQrCode()" placeholder="{{ __("yourpaypalmelink") }}" autocomplete="off" required>\
                                        </div>\
                                    </div>\
                                </div>';
                $('#generate').html(generateCode);
            ...
            if(type == "upi") {
                // Upi
                $('#selectedQrCodeType').val('upi');
                generateCode = '<div class="col-md-12 col-xl-12">\
                                    <div class="mb-3">\
                                        <label class="form-label required">{{ __("UPI ID / VPA") }}</label>\
                                        <input type="text" class="form-control" onchange="regenerateQrCode()" maxlength="150" placeholder="{{ __("Eg: abi@okicici") }}" name="upi_id" id="upi_id" required autocomplete="off">\
                                    </div>\
                                </div>\
                                <div class="col-md-12 col-xl-12">\
                                    <div class="mb-3">\
                                        <label class="form-label required">{{ __("Payee Name") }}</label>\
                                        <input type="text" class="form-control" onchange="regenerateQrCode()" maxlength="50" placeholder="{{ __("Eg: Abi") }}" name="upi_payee_name" id="upi_payee_name" required autocomplete="off">\
                                    </div>\
                                </div>\
                                <div class="col-md-12 col-xl-12">\
                                    <div class="mb-3">\
                                        <label class="form-label required">{{ __("Currency") }}</label>\
                                        <select class="form-select" name="upi_currency" id="upi_currency" onchange="regenerateQrCode()" required>\
                                            @include("admin.pages.qr-codes.includes.currency")\
                                        </select>\
                                    </div>\
                                </div>\
                                <div class="col-md-12 col-xl-12">\
                                    <div class="mb-3">\
                                        ...
                                        <input type="number" min="0" step="0.001" max="100000" placeholder="{{ __("Eg: 500") }}" class="form-control" onchange="regenerateQrCode()" placeholder="{{ __("Amount") }}" name="upi_amount" id="upi_amount" autocomplete="off">\
                                    </div>\
                                </div>\
                                <div class="col-md-12 col-xl-12">\
                                    <div class="mb-3">\
                                        <label class="form-label">{{ __("Transaction Remark") }}</label>\
                                        <textarea name="upi_msg" id="upi_msg" maxlength="150" class="form-control" onchange="regenerateQrCode()" placeholder="{{ __("Transaction Remark") }}" cols="30" rows="2"></textarea>\
                                    </div>\
                                </div>';
                $('#generate').html(generateCode);
            }
        ...
        function regenerateQrCode() {
            "use strict";
            var qrcode_type = $("#selectedQrCodeType").val();
            var phone = $("#phone").val();
            var email = $("#email").val();
