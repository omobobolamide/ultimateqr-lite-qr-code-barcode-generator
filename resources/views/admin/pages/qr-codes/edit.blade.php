                ...
                @if ($qr_code_details)
                    <div class="row row-deck row-cards">
                        <div class="col-sm-12 col-lg-12">
                            {{-- Update Form --}}
                            <form action="{{ route('admin.update.qr') }}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="col">
                                    <div class="row">
                                                    ...
                                                    @if ($qr_code_details->type == 'whatsapp')
                                                        ...
                                                        <div class="col-md-12 col-xl-12">
                                                            <div class="mb-3">
                                                                <label
                                                                    class="form-label required">{{ __('Message') }}</label>
                                                                <textarea name="content" id="content" maxlength="350" class="form-control" cols="30" rows="5"
                                                        ...
                                                        <div class="col-md-12 col-xl-12">
                                                            <div class="mb-3">
                                                                ...
                                                                <input type="url" class="form-control"
                                                                    ...
                                                                    placeholder="{{ __('Website URL') }}" required>
                                                            </div>
                                                        </div>
                                                    ...
                                                    @if ($qr_code_details->type == 'upi')
                                                        ...
                                                        <div class="col-md-12 col-xl-12">
                                                            <div class="mb-3">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    maxlength="150" onchange="regenerateQrCode()"
                                                        ...
                                                        <div class="col-md-12 col-xl-12">
                                                            <div class="mb-3">
                                                                ...
                                                                <textarea name="upi_msg" id="upi_msg" maxlength="150" class="form-control" onchange="regenerateQrCode()"
