            ...
            <div class="page-header d-print-none">
                <div class="row align-items-center">
                    ...
                    <div class="col-auto ms-auto d-print-none">
                        <div class="btn-list">
                            {{-- Bluk upload --}}
                            <a href="{{ route('admin.bulk.upload') }}" class="btn btn-primary d-none d-sm-inline-block">
                            ...
                            <a href="{{ route('admin.create.barcode') }}" class="btn btn-primary d-none d-sm-inline-block">
                            ...
                            {{-- Mobile --}}
                            {{-- Bluk upload --}}
                            <a href="{{ route('admin.bulk.upload') }}" class="btn btn-primary d-sm-none btn-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-upload"
                                    width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor"
                                    fill="none" stroke-linecap="round" stroke-linejoin="round">
                                    <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                            ...
                            {{-- Create single barcode --}}
                            <a href="{{ route('admin.create.barcode') }}" class="btn btn-primary d-sm-none btn-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24"
                                    viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none"
                                    stroke-linecap="round" stroke-linejoin="round">
                                    <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($bar_codes as $bar_code)
                                            <tr>
                                                ...
                                                <td><a href="{{ route('admin.view.group', $bar_code->group_id ? $bar_code->group_id : "general") }}">{{ __($bar_code->group_name ? $bar_code->group_name : "General") }}</a></td>
                                                <td><a href="{{ route('admin.download.barcode', $bar_code->barcode_id) }}">{{ $bar_code->name }}</a></td>
                                                ...
                                                <td class="text-start">
                                                    <span class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-end" style="">
                                                            <a class="dropdown-item" href="{{ route('admin.download.barcode', $bar_code->barcode_id) }}">{{ __('Download Barcode') }}</a>
                                                            <a class="dropdown-item"
                                                                href="{{ route('admin.edit.barcode', $bar_code->barcode_id) }}">{{ __('Edit') }}</a>
...
@section('custom-js')
    <script>
        ...
        function updateBarStatus(statusBarCodeId, statusBarCodeStatus) {
            ...
            status_link.setAttribute("href", "{{ route('admin.update.barcode.status') }}?id=" + statusBarCodeId);
        }
        ...
        function deleteBar(deleteBarCodeId, deleteBarCodeStatus) {
            ...
            delete_link.setAttribute("href", "{{ route('admin.delete.barcode') }}?id=" + deleteBarCodeId);
        }
    </script>
@endsection
@endsection
