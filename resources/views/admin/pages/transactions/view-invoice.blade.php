...
@section('custom-css')
    ...
    <script>
        function generatePDF() {
            ...
            html2pdf()
                .set({
                    filename: `{{ $transaction->invoice_prefix ? $transaction->invoice_prefix : 'TR' }}{{ $transaction->invoice_number ? $transaction->invoice_number : $transaction->transaction_id }}` + '.pdf',
                    html2canvas: {
                        scale: 4
                    }
                })
