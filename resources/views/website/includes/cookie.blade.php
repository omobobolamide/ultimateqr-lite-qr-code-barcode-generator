{{-- Cookie --}}
<div class="fixed bottom-0 z-50 w-full p-6 md:p-12">
    <div class="p-10 w-full bg-white max-w-3xl border border-coolGray-100 rounded-md shadow-md">
        <div class="flex flex-wrap items-center -mx-4">
            <div class="w-full md:w-1/2 px-4 mb-8 md:mb-0">
                <p class="mb-4 text-coolGray-500 font-medium">{{ __('We use third-party cookies in order to personalise
                    your
                    experience') }}</p>
                <a class="flex items-center font-medium text-blue-500 hover:text-blue-600" href="#">
            ...
            <div class="w-full md:w-1/2 px-4">
                <div class="flex flex-wrap justify-end">
                    <div class="w-full md:w-auto py-1 md:py-0 md:mr-4"><a
                            ...
                            href="#">{{ __('Decline') }}</a></div>
                    <div class="w-full md:w-auto py-1 md:py-0"><a
                            class="inline-block py-3 px-5 w-full leading-5 text-white bg-blue-500 hover:bg-blue-600 font-medium text-center focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 border border-transparent rounded-md shadow-sm"
                            href="#">{{ __('Allow') }}</a></div>
                </div>
            </div>
        </div>
