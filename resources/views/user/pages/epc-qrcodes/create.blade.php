                ...
                <div class="row row-deck row-cards">
                    <div class="col-sm-12 col-lg-12">
                        <div class="col">
                            ...
                            <div class="col">
                                {{-- Text --}}
                                <form action="{{ route('user.save.epc.qr') }}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    <div class="col">
                                        <div class="row">
                                            ...
                                            <div class="col-xl-5 col-lg-5 col-md-5 mb-3">
                                                <div class="sticky-top card p-3">
                                                    ...
                                                    <div id="regenerate_qr"
                                                        ...
                                                        <img width="100%"
                                                            src="{{ asset('images/user/qr-code/epc/demo.png') }}">
                                                    </div>
                                                                    ...
                                                                    <div class="form-selectgroup">
                                                                        <label class="form-selectgroup-item">
                                                                            <input type="radio" name="version"
                                                                                id="version" value="1"
                                                                                onclick="regenerateEPCQrCode()" checked
        ...
        function regenerateEPCQrCode() {
            ...
            if (purpose.length < 1 || purpose.length >= 4) {
                ...
                $.ajax({
                    ...
                    url: `{{ route('user.regenerate.epc.qr') }}`,
                    method: 'POST',
