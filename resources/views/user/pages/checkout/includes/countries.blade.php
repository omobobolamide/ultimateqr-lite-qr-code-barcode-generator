<option {{ Auth::user()->billing_country == null ? 'selected' : '' }} value="" selected disabled>{{ __('Choose Country') }}</option>
...
<option {{ Auth::user()->billing_country == "Cote D'ivoire" ? 'selected' : '' }} value="Cote Divoire">{{ __('Cote Divoire') }}</option>
...
<option {{ Auth::user()->billing_country == "Korea, Democratic People's Republic of" ? 'selected' : '' }} value="Korea, Democratic Peoples Republic of">{{ __('Korea, Democratic Peoples Republic of') }}</option>
...
<option {{ Auth::user()->billing_country == "Lao People's Democratic Republic" ? 'selected' : '' }} value="Lao Peoples Democratic Republic">{{ __('Lao Peoples Democratic Republic') }}</option>
