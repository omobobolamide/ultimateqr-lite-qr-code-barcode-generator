            ...
            <div class="page-header d-print-none">
                <div class="row align-items-center">
                    ...
                    <div class="col-auto ms-auto d-print-none">
                        <div class="d-flex">
                            <a href="{{ route('user.create.qr') }}" class="btn btn-primary">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($qr_codes as $qr_code)
                                            <tr>
                                                ...
                                                <td><a href="{{ route('user.type.qrcodes', strtolower($qr_code->type)) }}"><span
                                                            class="badge bg-dark text-white">{{ strtoupper($qr_code->type) }}</span></a>
                                                </td>
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-end" style="">
                                                            @if ($qr_code->type == 'url')
                                                                <a class="dropdown-item" target="_blank"
                                                                    href="{{ route('user.qr.statistics', $qr_code->qr_code_id) }}">{{ __('Statistics') }}</a>
                                                            @endif
