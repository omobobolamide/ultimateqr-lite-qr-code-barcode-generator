            ...
            <div class="container-xl">
                ...
                <div class="row row-deck row-cards">
                    ...
                    <div class="col-sm-12 col-lg-12">
                        <form action="{{ route('user.save.barcode') }}" method="post" class="card"
                                ...
                                <div class="row">
                                            ...
                                            <div class="col-md-6 col-xl-6">
                                                <div class="mb-3">
                                                    ...
                                                    <select class="form-select" name="barcode_type" id="barcode_type"
                                                        onchange="getFormat(this)" required>
                                                        <option selected value="DNS1D">{{ __('1D') }}</option>
                                                        <option value="DNS2D">{{ __('2D') }}</option>
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-12 col-xl-12">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" name="content"
                                                        id="content" minlength="1" onchange="regenerateBarCode()"
                                                        required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6 col-xl-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="number" class="form-control" name="width"
                                                        id="width" value="3" onchange="regenerateBarCode()"
                                                        required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6 col-xl-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="number" class="form-control" name="height"
                                                        id="height" value="83" onchange="regenerateBarCode()"
                                                        required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-12 col-xl-12">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="color" class="form-control" name="color"
                                                        id="color" value="#000000" onchange="regenerateBarCode()"
                                                        required>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-xl-6">
                                        ...
                                        <div id="regenerate_barcode" class="visible-print text-center code-style">
                                            {!! DNS1D::getBarcodeSVG('1234567890', 'MSI', 3, 83, '#000000', true) !!}
                                        </div>
...
@section('custom-js')
    <script>
        ...
        function regenerateBarCode() {
            ...
            if (content != '') {
                ...
                $.ajax({
                    ...
                    url: `{{ route('user.regenerate.barcode') }}`,
                    type: 'POST',
        ...
        // Default options
        $("#barcode_format").html(
            "<option value='C39'>{{ __('C39') }}</option><option value='C39+'>{{ __('C39+') }}</option><option value='C39E'>{{ __('C39E') }}</option><option value='C39E+'>{{ __('C39E+') }}</option><option value='C93'>{{ __('C93') }}</option><option value='S25'>{{ __('S25') }}</option><option value='S25+'>{{ __('S25+') }}</option><option value='I25'>{{ __('I25') }}</option><option value='I25+'>{{ __('I25+') }}</option><option value='C128'>{{ __('C128') }}</option><option value='C128A'>{{ __('C128A') }}</option><option value='C128B'>{{ __('C128B') }}</option><option value='EAN2'>{{ __('EAN2') }}</option><option value='EAN5'>{{ __('EAN5') }}</option><option value='EAN8'>{{ __('EAN8') }}</option><option value='EAN13'>{{ __('EAN13') }}</option><option value='UPCA'>{{ __('UPCA') }}</option><option value='UPCE'>{{ __('UPCE') }}</option><option value='MSI'>{{ __('MSI') }}</option><option value='MSI+'>{{ __('MSI+') }}</option><option value='POSTNET'>{{ __('POSTNET') }}</option><option value='PLANET'>{{ __('PLANET') }}</option><option value='RMS4CC'>{{ __('RMS4CC') }}</option><option value='KIX'>{{ __('KIX') }}</option><option value='IMB'>{{ __('IMB') }}</option><option value='CODABAR'>{{ __('CODABAR') }}</option><option value='CODE11'>{{ __('CODE11') }}</option><option value='PHARMA'>{{ __('PHARMA') }}</option><option value='PHARMA2T'>{{ __('PHARMA2T') }}</option>"
        );
        ...
        function getFormat(type) {
            ...
            if (getFormat == "DNS2D") {
                $("#barcode_format").html(
                    "<option value='QRCODE'>{{ __('QRCODE') }}</option><option value='PDF417'>{{ __('PDF417') }}</option><option value='DATAMATRIX'>{{ __('DATAMATRIX') }}</option>"
                );
                $("#width").val('500');
                $("#height").val('500');
            }
